...
export default class LoadingScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("ship_player_1", "assets/hero_ship.png");
        this.load.image("ship_player_1_highlight", "assets/hero_ship.png");
        this.load.image("ship_player_1_thrusts_forward", "assets/hero_ship.png");
        this.load.image("ship_player_1_thrusts_backward", "assets/hero_ship.png");
